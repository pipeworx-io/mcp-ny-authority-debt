...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/ny_authority_debt_search \
  -H 'Content-Type: application/json' \
  -d '{"authority":"Dormitory","min_amount":100000000,"limit":3}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/ny_authority_debt_search`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
